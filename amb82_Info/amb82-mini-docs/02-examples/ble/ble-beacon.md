...
Ensure that the following Bluetooth apps are installed on your mobile phone:
...
The `BLEBeacon` library includes both iBeacon and AltBeacon classes, replace line 6 iBeacon with altBeacon to create an AltBeacon instead.
