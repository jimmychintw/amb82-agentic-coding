...
Connect the servo, LEDs, button, and SD card according to the schematic.
...
Open the Adafruit Bluefruit app on your smartphone, scan and connect to the Ameba board shown as "AMEBA_BLE" or any BLE device name that has been set. Then, choose UART function in the app.
