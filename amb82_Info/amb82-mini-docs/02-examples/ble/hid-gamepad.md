...
In this example, the AmebaPro2 board emulates a HID gamepad connected using BLE.
...
On Windows, gamepad input can also be viewed by going to Control Panel -> Devices and Printers -> AMEBA_BLE_HID -> Game Controller Settings -> Properties.

On Android, gamepad testing apps can also be used to view the gamepad input.
