NAU7802 External Calibration — Ameba Arduino AIoT Documentation v1.1 documentation
- 
[](../../../../index.html)
...
- 
[ Edit on GitHub](https://github.com/Ameba-AIoT/ameba-arduino-doc/blob/main/source/ameba_pro2/amb82-mini/Example_Guides/I2C/NAU7802 External Calibration.rst)
# NAU7802 External Calibration[](#nau7802-external-calibration)
## Materials[](#materials)
...
[](../../../../_images/image01158.png)
## Example[](#example)
### Introduction[](#introduction)
This example shows how to calibrate SparkFun NAU7802 to get actual measurements (in grams) from a Load Cell, similar to the **NAU7802 Complete Scale** example, using NAU7802’s external calibration function and internal offset register to store the zero point. By default `.begin` performs an `_internal_ calibration`. In this example we overwrite the offset register with the result of the `_external_` calibration.
### Procedure[](#procedure)
...
[](../../../../_images/image02153.png)
Open the example in File -> Examples -> AmebaWire -> NAU7802 -> ExternalCalibration
[](../../../../_images/image03132.png)
...
### Step 3: Calibration Complete[](#step-3-calibration-complete)
After completing all above steps, your scale is now calibrated! The Serial Monitor will continuously display weight readings every second.
...
Note
This calibration example is identical to **NAU7802 Complete Scale** example, except that this leverages external calibration.
[ Previous](NAU7802%20Complete%20Scale.html)
[Next ](NAU7802%20Gain%20Sample%20Rate.html)
[
