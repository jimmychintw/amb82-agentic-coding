...
First, connect AMB82 MINI to the computer via Micro USB. If this is the first time connects board to computer, the USB driver for board will be automatic installed.
...
Next, go to Tools -> Board -> Boards Manager. Find "Realtek Ameba Boards" in the list, click "Install", then the Arduino IDE starts to download required files.
...
| Upload Speed | **2000000** / **1000000** / **230400** - Upload baud rate | |
| Erase All Flash Memory (16MB) | **Disable** / **Erase only** / **Erase then Upload** | |
| Camera Options | JFX37, JFX53, GC2053, GC4653, GC5035, IMX307, IMX327, IMX662, PS5268, OV9734, SC2336 | |
| Camera FCS Mode | **Disable** / **Enable** | |
| NN Model Load From | **Flash** / **SD Card** | |
| OTA Mode | **Disable** / **Enable** | |
| Standard Lib | **Arduino_STD_PRINTF** / **Disable** | |
| Arduino: API logs | **Enable all** / **Error logs** / **Info logs** / **Disable all** | |
| System: Multimedia logs | **Enable all** / **Video/OSD logs only** / **NN/OSD logs only** / **Disable all** | |
| System: WiFi logs | **Enable** / **Disable** | |
| All logs: Hard mute | **Disable** / **Enable** | |
